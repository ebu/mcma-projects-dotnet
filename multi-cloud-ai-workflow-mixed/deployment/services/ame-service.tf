...
resource "aws_lambda_function" "ame-service-api-handler" {
  filename         = "./../services/Mcma.Aws.AmeService/ApiHandler/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.AmeService/ApiHandler/dist/function.zip")}"
...
resource "aws_lambda_function" "ame-service-worker" {
  filename         = "./../services/Mcma.Aws.AmeService/Worker/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.AmeService/Worker/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "300"
  memory_size      = "3008"
}
