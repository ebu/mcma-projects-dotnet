...
resource "aws_lambda_function" "azure-ai-service-api-handler" {
  filename         = "./../services/Mcma.Aws.AzureAiService/ApiHandler/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.AzureAiService/ApiHandler/dist/function.zip")}"
...
resource "aws_lambda_function" "azure-ai-service-api-handler-non-secure" {
  filename         = "./../services/Mcma.Aws.AzureAiService/ApiInsecure/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.AzureAiService/ApiInsecure/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
}
...
resource "aws_lambda_function" "azure-ai-service-worker" {
  filename         = "./../services/Mcma.Aws.AzureAiService/Worker/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.AzureAiService/Worker/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "300"
  memory_size      = "3008"
}
