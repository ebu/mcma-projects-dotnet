...
resource "aws_lambda_function" "job-repository-api-handler" {
  filename         = "./../services/Mcma.Aws.JobRepository/ApiHandler/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.JobRepository/ApiHandler/dist/function.zip")}"
...
resource "aws_lambda_function" "job-repository-worker" {
  filename         = "./../services/Mcma.Aws.JobRepository/Worker/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.JobRepository/Worker/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
}
