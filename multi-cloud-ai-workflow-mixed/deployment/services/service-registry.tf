...
resource "aws_lambda_function" "service-registry-api-handler" {
  filename         = "./../services/Mcma.Aws.ServiceRegistry/ApiHandler/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.ServiceRegistry/ApiHandler/dist/function.zip")}"
