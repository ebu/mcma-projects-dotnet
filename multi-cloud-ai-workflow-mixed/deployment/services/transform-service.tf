...
resource "aws_lambda_function" "transform-service-api-handler" {
  filename         = "./../services/Mcma.Aws.TransformService/ApiHandler/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.TransformService/ApiHandler/dist/function.zip")}"
...
resource "aws_lambda_function" "transform-service-worker" {
  filename         = "./../services/Mcma.Aws.TransformService/Worker/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../services/Mcma.Aws.TransformService/Worker/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "300"
  memory_size      = "3008"
}
