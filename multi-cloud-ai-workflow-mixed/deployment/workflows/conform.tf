...
resource "aws_lambda_function" "conform-01-validate-workflow-input" {
  filename         = "./../workflows/conform/01-ValidateWorkflowInput/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/01-ValidateWorkflowInput/dist/function.zip")}"
...
resource "aws_lambda_function" "conform-02-move-content-to-file-repository" {
  filename         = "./../workflows/conform/02-MoveContentToFileRep/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/02-MoveContentToFileRep/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-03-create-media-asset" {
  filename         = "./../workflows/conform/03-CreateMediaAsset/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/03-CreateMediaAsset/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-04-extract-technical-metadata" {
  filename         = "./../workflows/conform/04-ExtractTechnicalMetadata/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/04-ExtractTechnicalMetadata/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-05-register-technical-metadata" {
  filename         = "./../workflows/conform/05-RegisterTechnicalMetadata/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/05-RegisterTechnicalMetadata/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-06-decide-transcode-requirements" {
  filename         = "./../workflows/conform/06-DecideTranscodeReqs/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/06-DecideTranscodeReqs/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-07a-short-transcode" {
  filename         = "./../workflows/conform/07a-ShortTranscode/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/07a-ShortTranscode/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-07b-long-transcode" {
  filename         = "./../workflows/conform/07b-LongTranscode/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/07b-LongTranscode/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-08-register-proxy-essence" {
  filename         = "./../workflows/conform/08-RegisterProxyEssence/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/08-RegisterProxyEssence/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-09-copy-proxy-to-website-storage" {
  filename         = "./../workflows/conform/09-CopyProxyToWebsiteStorage/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/09-CopyProxyToWebsiteStorage/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-10-register-proxy-website-locator" {
  filename         = "./../workflows/conform/10-RegisterProxyWebsiteLoc/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/10-RegisterProxyWebsiteLoc/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "conform-11-start-ai-workflow" {
  filename         = "./../workflows/conform/11-StartAiWorkflow/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/conform/11-StartAiWorkflow/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
