...
resource "aws_lambda_function" "process-workflow-completion" {
  filename         = "./../workflows/ProcessWorkflowCompletion/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/ProcessWorkflowCompletion/dist/function.zip")}"
...
resource "aws_lambda_function" "process-workflow-failure" {
  filename         = "./../workflows/ProcessWorkflowFailure/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/ProcessWorkflowFailure/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
...
resource "aws_lambda_function" "workflow-activity-callback-handler" {
  filename         = "./../workflows/WorkflowActivityCallbackHandler/dist/function.zip"
  ...
  source_code_hash = "${filebase64sha256("./../workflows/WorkflowActivityCallbackHandler/dist/function.zip")}"
  runtime          = "dotnetcore2.1"
  timeout          = "30"
  memory_size      = "256"
}
