locals {
  job_processor_api_handler_zip_file          = "../services/JobProcessor/Mcma.Aws.JobProcessor.ApiHandler/dist/function.zip"
  job_processor_worker_zip_file               = "../services/JobProcessor/Mcma.Aws.JobProcessor.Worker/dist/function.zip"
  job_processor_periodic_job_checker_zip_file = "../services/JobProcessor/Mcma.Aws.JobProcessor.PeriodicJobChecker/dist/function.zip"
  job_processor_periodic_job_cleanup_zip_file = "../services/JobProcessor/Mcma.Aws.JobProcessor.PeriodicJobCleanup/dist/function.zip"
}
