locals {
  mediainfo_service_api_zip_file      = "./../services/MediaInfoService/Mcma.Azure.MediaInfoService.ApiHandler/dist/function.zip"
  mediainfo_service_worker_zip_file   = "./../services/MediaInfoService/Mcma.Azure.MediaInfoService.Worker/dist/function.zip"
...
resource "azurerm_function_app" "mediainfo_service_worker_function" {
  ...
  app_settings = {
    ...
    MCMA_TABLE_NAME                      = azurerm_cosmosdb_sql_container.mediainfo_service_cosmosdb_container.name
...
resource "azurerm_function_app" "mediainfo_service_api_function" {
  ...
  app_settings = {
    ...
    MCMA_COSMOS_DB_DATABASE_ID = local.cosmosdb_id
    MCMA_COSMOS_DB_REGION      = var.azure_location
    MCMA_WORKER_QUEUE_NAME     = azurerm_storage_queue.mediainfo_service_worker_function_queue.name
  }
}
