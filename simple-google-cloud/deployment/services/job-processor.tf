locals {
  job_processor_api_zip_file      = "../Services/JobProcessor/Mcma.GoogleCloud.JobProcessor.ApiHandler/dist/function.zip"
  ...
  job_processor_periodic_job_checker_zip_file      = "../Services/JobProcessor/Mcma.GoogleCloud.JobProcessor.PeriodicJobChecker/dist/function.zip"
  ...
  job_processor_periodic_job_cleanup_zip_file      = "../Services/JobProcessor/Mcma.GoogleCloud.JobProcessor.PeriodicJobCleanup/dist/function.zip"
  ...
  job_processor_worker_zip_file = "../Services/JobProcessor/Mcma.GoogleCloud.JobProcessor.Worker/dist/function.zip"
}
...
resource "google_cloudfunctions_function" "job_processor_api_handler" {
  ...
  trigger_http          = true
  entry_point           = "Mcma.GoogleCloud.JobProcessor.ApiHandler.JobProcessorApiHandler"

  service_account_email = google_service_account.service_account.email

  environment_variables = {
    MCMA_TABLE_NAME            = "job-processor"
    MCMA_PUBLIC_URL            = local.job_processor_api_url
    MCMA_WORKER_PUBSUB_TOPIC   = google_pubsub_topic.job_processor_work_topic.name
...
resource "google_cloudfunctions_function" "job_processor_periodic_job_checker" {
  ...
  trigger_http          = true
  entry_point           = "Mcma.GoogleCloud.JobProcessor.PeriodicJobChecker.PeriodicJobCheckerFunction"

  service_account_email = google_service_account.service_account.email

  environment_variables = {
    MCMA_TABLE_NAME                     = "job-processor"
    MCMA_PUBLIC_URL                     = local.job_processor_periodic_job_checker_url
    MCMA_WORKER_PUBSUB_TOPIC            = google_pubsub_topic.job_processor_work_topic.name
    MCMA_SERVICES_URL                   = "${local.service_registry_api_url}/services"
    MCMA_SERVICES_AUTH_TYPE             = "Google"
    MCMA_SERVICES_AUTH_CONTEXT          = "{ \"scopes\": \"${local.service_registry_api_url}\" }"
    MCMA_CLOUD_SCHEDULER_JOB_NAME       = google_cloud_scheduler_job.job_processor_periodic_job_checker_cron.id
...
resource "google_cloudfunctions_function" "job_processor_periodic_job_cleanup" {
  ...
  trigger_http          = true
  entry_point           = "Mcma.GoogleCloud.JobProcessor.PeriodicJobCleanup.PeriodicJobCleanupFunction"

  service_account_email = google_service_account.service_account.email

  environment_variables = {
    MCMA_TABLE_NAME                   = "job-processor"
    MCMA_PUBLIC_URL                   = local.job_processor_periodic_job_cleanup_url
    MCMA_WORKER_PUBSUB_TOPIC          = google_pubsub_topic.job_processor_work_topic.name
    MCMA_SERVICES_URL                 = "${local.service_registry_api_url}/services"
    MCMA_SERVICES_AUTH_TYPE           = "Google"
    MCMA_SERVICES_AUTH_CONTEXT        = "{ \"scopes\": \"${local.service_registry_api_url}\" }"
...
resource "google_cloudfunctions_function" "job_processor_worker" {
  ...
  entry_point           = "Mcma.GoogleCloud.JobProcessor.Worker.JobProcessorWorker"
